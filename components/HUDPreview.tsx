...
const MOCK_DATA: HUDData = {
    ...
    score: { current: 24500, high: 50000, combo: 6, comboMultiplier: 1.6, comboTimerPct: 0.7 },
...
export const HUDPreview: React.FC<HUDPreviewProps> = ({ layoutId, width = 384, height = 300 }) => {
    ...
    // Create a fake game background as children for the HUD
    const fakeGameLayer = (
    ...
    return (
        <div className="relative overflow-hidden flex items-start justify-center bg-gray-900 border border-gray-800 rounded" style={{ width, height }}>
             <div
                style={{
             ...
             >
                 {/* The HUD View with fake game as children */}
