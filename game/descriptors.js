export const DESCRIPTOR_REGISTRY = {
    ...
    SHOCKWAVE: { id: 'SHOCKWAVE', name: 'SEISMIC SLAM', description: 'Increases the blast radius and damage of your System Shock ability.', category: 'WEAPON', rarity: 'COMMON', icon: '💥', color: 'text-blue-400', maxLevel: 10 },
    ...
    EMP_BLOOM: { id: 'EMP_BLOOM', name: 'EMP BLOOM', description: 'Automatically triggers a System Shock when your Shield breaks.', category: 'REACTIVE', rarity: 'RARE', icon: '🎇', color: 'text-blue-300', maxLevel: 1 },
