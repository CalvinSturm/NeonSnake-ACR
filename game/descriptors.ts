...
export const DESCRIPTOR_REGISTRY: Record<string, Descriptor> = {
  ...
  OVERCLOCK_WEAPON_SLOT: { id: 'OVERCLOCK_WEAPON_SLOT', name: 'OVERCLOCK // BREAK', description: 'UNSANCTIONED: Force-enables an additional weapon slot.', category: 'SYSTEM', rarity: 'LEGENDARY', icon: '🔓', color: 'text-red-600', maxLevel: 1 }
};
