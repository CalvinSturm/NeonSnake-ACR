...
export const UPGRADE_FACTORIES = {
    CANNON: ({ weapon }) => ({
        ...
        description: weapon.cannonLevel >= 3
    ...
    NANO_SWARM: ({ weapon }) => ({
        id: 'NANO_SWARM',
        title: weapon.nanoSwarmLevel === 0
            ? 'UNLOCK NANO SWARM'
            : `NANO SWARM MK ${weapon.nanoSwarmLevel + 1}`,
        description: weapon.nanoSwarmLevel === 0
    ...
    MINES: ({ weapon }) => ({
        id: 'MINES',
        title: weapon.mineLevel === 0
            ? 'UNLOCK PLASMA MINES'
            : `PLASMA MINES MK ${weapon.mineLevel + 1}`,
        description: weapon.mineLevel === 0
    ...
    LIGHTNING: ({ weapon }) => ({
        id: 'LIGHTNING',
        title: weapon.chainLightningLevel === 0
            ? 'UNLOCK VOLTAIC ARC'
